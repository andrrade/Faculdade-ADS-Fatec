...
function principal(){
    ...
    do {
        ...
        switch(opcao){
            case 1: inserir(vetor)
                    break
            case 2: removeValor(vetor)
                    break
            case 3: RemoverPosição(vetor)
                    break
            case 4: SomarElementos(vetor)
                    break
            case 5: alert(vetor)
                    break
            case 6: Somarindices(vetor)
                    break
            case 7: alert('Fim do programa')
                    break
